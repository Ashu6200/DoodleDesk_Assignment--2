...
const Hero: React.FC = () => {
    ...
    return (
        <div className='relative'>
            <HCFHeader leftSide={
                <>
                    <h1 className="text-3xl lg:text-5xl font-bold text-white mb-6 leading-tight text-center" style={{
                    ...
                    <p className="text-[15px] sm:text-[17px] text-gray-300 mx-auto mt-2 sm:mt-6 leading-shorter md:leading-normal text-center" style={{
                        fontFamily: themeConfig.typography.fontFamily.heading,
                    }}>
                        {themeConfig.marketing.subheading}
                    </p>
                </>
            } />
